 ...
 */
bool
ControlList::rt_safe_earliest_event (timepos_t const & start, timepos_t & x, double& y, bool inclusive) const
{
 ...
 */
bool
ControlList::rt_safe_earliest_event_unlocked (timepos_t const & start, timepos_t & x, double& y, bool inclusive) const
{
	if (_interpolation == Discrete) {
 ...
 */
bool
ControlList::rt_safe_earliest_event_linear_unlocked (timepos_t const & start_time, timepos_t & x, double& y, bool inclusive) const
{
	timepos_t start = start_time;
